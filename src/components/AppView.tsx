          ...
          {chatMessages.length === 0 ? (
            ...
            <div className="mx-auto max-w-3xl space-y-6">
              {chatMessages.map((msg, idx) => (
                ...
                >
                  <div className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full ${msg.role === 'user' ? 'bg-slate-700' : 'bg-gradient-to-br from-blue-500 to-indigo-600'
                    }`}>
                    {msg.role === 'user' ? (
